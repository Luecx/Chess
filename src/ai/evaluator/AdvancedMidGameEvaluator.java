...
//                    addScalarToTensor(flipTensor(KING_VALUES_MID), EVALUATE_PRICE[6]));
    ...
    private double PARAMETER_QUEEN_TABLE_FACTOR     = 98.0;
    private double PARAMETER_KING_TABLE_FACTOR      = 100;


    private double PARAMETER_PAWN_VALUE             = 229.0;
    private double PARAMETER_ROOK_VALUE             = 970.0;
    private double PARAMETER_KNIGHT_VALUE           = 672.0;
    private double PARAMETER_BISHOP_VALUE           = 689.0;
    private double PARAMETER_QUEEN_VALUE            = 1370.0;
    private double PARAMETER_KING_VALUE             = 20039.0;

    //add for every attacked field
    private double PARAMETER_ROOK_VISIBILITY         = 21.0;
    private double PARAMETER_BISHOP_VISIBILITY       = 14.0;
    private double PARAMETER_KNIGHT_VISIBILITY       = 19.0;
    private double PARAMETER_QUEEN_VISIBILITY        = 38.0;

    //add for every attacked field which is covered by opponent pawns
    private double PARAMETER_ROOK_VISIBILITY_PAWN_COVER           = -13.0;
    private double PARAMETER_BISHOP_VISIBILITY_PAWN_COVER         = 1.0;
    private double PARAMETER_KNIGHT_VISIBILITY_PAWN_COVER         = -9.0;
    private double PARAMETER_QUEEN_VISIBILITY_PAWN_COVER          = -48.0;


    //add if the amount of attacks to uncovered squares is 0
    private double PARAMETER_ROOK_TRAPPED                = -43.0;
    private double PARAMETER_BISHOP_TRAPPED              = -47.0;
    private double PARAMETER_KNIGHT_TRAPPED              = -42.0;
    private double PARAMETER_QUEEN_TRAPPED               = -45.0;

    private double PARAMETER_ROOK_KING_LINE         = 56.0;

    private double PARAMETER_PASSED_PAWN        = 86.0;
    private double PARAMETER_ISOLATED_PAWN      = -15.0;
    private double PARAMETER_DOUBLED_PAWN       = -66.0;
    private double PARAMETER_DOUBLE_BISHOP      = 118.0;
    private double PARAMETER_KING_SAFETY_1      = 22.0;       //10
    private double PARAMETER_KING_SAFETY_2      = 58.0;       //18
    private double PARAMETER_ROOK_HALF_OPEN     = 49.0;
    private double PARAMETER_ROOK_OPEN          = 4.0;
    private double PARAMETER_CONNECTED_PAWN     = 11.0;
