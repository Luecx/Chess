...
public interface Evaluator<T extends Evaluator<T>> {
    ...
    public static void main(String[] args) {
       //createFunction_getEvolvableValues(AdvancedEvaluator.class);
        ...
        compareParams("private double CONST_PARAMETER_KING_VALUE_EARLY = 10000.0D;\n"
                      + "    private double CONST_PARAMETER_PAWN_VALUE_LATE = 100.0D;\n"
                      + "    private double CONST_PARAMETER_KING_VALUE_LATE = 10000.0D;\n"
                      + "    private double CONST_PARAMETER_PAWN_VALUE_EARLY = 100.0D;\n"
                      + "    private double PARAMETER_PAWN_TABLE_FACTOR_EARLY = 44.0D;\n"
                      + "    private double PARAMETER_PAWN_CONNECTED_EARLY = 5.0D;\n"
                      + "    private double PARAMETER_PAWN_PASSED_EARLY = 38.0D;\n"
                      + "    private double PARAMETER_PAWN_ISOLATED_EARLY = -7.0D;\n"
                      + "    private double PARAMETER_PAWN_DOUBLED_EARLY = -29.0D;\n"
                      + "    private double PARAMETER_KNIGHT_TABLE_FACTOR_EARLY = 44.0D;\n"
                      + "    private double PARAMETER_KNIGHT_VALUE_EARLY = 293.0D;\n"
                      + "    private double PARAMETER_KNIGHT_VISIBILITY_EARLY = 8.0D;\n"
                      + "    private double PARAMETER_KNIGHT_VISIBILITY_PAWN_COVER_EARLY = -4.0D;\n"
                      ...
                      + "    private double PARAMETER_ROOK_VISIBILITY_PAWN_COVER_EARLY = -6.0D;\n"
                      + "    private double PARAMETER_ROOK_TRAPPED_EARLY = -19.0D;\n"
                      + "    private double PARAMETER_ROOK_KING_LINE_EARLY = 24.0D;\n"
                      + "    private double PARAMETER_ROOK_HALF_OPEN_EARLY = 21.0D;\n"
                      + "    private double PARAMETER_ROOK_OPEN_EARLY = 2.0D;\n"
                      ...
                      + "    private double PARAMETER_BISHOP_TRAPPED_EARLY = -21.0D;\n"
                      + "    private double PARAMETER_BISHOP_DOUBLED_EARLY = 52.0D;\n"
                      + "    private double PARAMETER_QUEEN_TABLE_FACTOR_EARLY = 43.0D;\n"
                      + "    private double PARAMETER_QUEEN_VALUE_EARLY = 650.0D;\n"
                      + "    private double PARAMETER_QUEEN_VISIBILITY_EARLY = 10.0D;\n"
                      + "    private double PARAMETER_QUEEN_TRAPPED_EARLY = -20.0D;\n"
                      + "    private double PARAMETER_QUEEN_VISIBILITY_PAWN_COVER_EARLY = -21.0D;\n"
                      ...
                      + "    private double PARAMETER_KING_PAWN_SHIELD_EARLY = 10.0D;\n"
                      + "    private double PARAMETER_PAWN_TABLE_FACTOR_LATE = 44.0D;\n"
                      + "    private double PARAMETER_PAWN_PASSED_LATE = 38.0D;\n"
                      + "    private double PARAMETER_PAWN_ISOLATED_LATE = -7.0D;\n"
                      + "    private double PARAMETER_PAWN_DOUBLED_LATE = -29.0D;\n"
                      + "    private double PARAMETER_PAWN_CONNECTED_LATE = 5.0D;\n"
                      + "    private double PARAMETER_ROOK_TABLE_FACTOR_LATE = 44.0D;\n"
                      + "    private double PARAMETER_ROOK_VALUE_LATE = 424.0D;\n"
                      + "    private double PARAMETER_ROOK_VISIBILITY_LATE = 9.0D;\n"
                      + "    private double PARAMETER_ROOK_VISIBILITY_PAWN_COVER_LATE = -6.0D;\n"
                      + "    private double PARAMETER_ROOK_TRAPPED_LATE = -19.0D;\n"
                      ...
                      + "    private double PARAMETER_KNIGHT_VISIBILITY_PAWN_COVER_LATE = -4.0D;\n"
                      ...
                      + "    private double PARAMETER_QUEEN_VALUE_LATE = 800.0D;\n"
                      + "    private double PARAMETER_QUEEN_VISIBILITY_LATE = 17.0D;\n"
                      + "    private double PARAMETER_QUEEN_VISIBILITY_PAWN_COVER_LATE = -21.0D;\n"
                      + "    private double PARAMETER_QUEEN_TRAPPED_LATE = -20.0D;\n"
