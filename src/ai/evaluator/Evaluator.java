...
public interface Evaluator<T extends Evaluator<T>> {
    ...
    public static void main(String[] args) {
       //createFunction_getEvolvableValues(AdvancedEvaluator.class);
        ...
        createParameters(AdvancedEvaluator.class, new double[]{
                79.0, 16.0, -3.0, -22.0, -3.0, 20.0, -10.0, 50.0, 479.0, 10.0, -15.0,
                -34.0, 152.0, 627.0, 5.0, -13.0, -6.0, 6.0, 26.0, 51.0, 144.0, 474.0,
                8.0, -10.0, -67.0, 40.0, 2.0, 15.0, 67.0, 1477.0, 3.0, 12.0, -16.0,
                144.0, 11.0, -73.0, -28.0, 20.0, 137.0, 69.0, -11.0, -9.0, 11.0, 55.0,
                -40.0, 82.0, 681.5, 5.0, 3.0, -16.0, 9.0, -1.0, -16.0, 156.0, 349.0,
                6.0, 3.0, -20.0, 91.0, 374.0, 2.0, 7.0, -2.0, 65.0, -12.0, 15.0, 46.0,
                1169.0, 9.0, 12.0, -69.0, 12.0, -7.0, 53.0, 13.0, 4.0
        });
